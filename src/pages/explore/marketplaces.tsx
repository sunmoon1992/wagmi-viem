  ...
  const columns = [
    {
      ...
      dataIndex: 'id',
      render: (_) => {
        return <span className="market-id">{_}</span>
      }
    },
    {
      title: 'Collection',
    ...
    },
    {
      ...
      render: (_) => {
        return (
          <Space size="mini">
            {_}
            <span className="market-unit">ETH</span>
          </Space>
        )
      }
    },
    {
      ...
      render: (_) => {
        return <span className="market-fall">{_}</span>
      }
    },
    {
      title: 'Volume',
    ...
    },
    {
      ...
      render: (_) => {
        return <span className="market-rise">{_}</span>
      }
    },
    {
      title: 'Items',
