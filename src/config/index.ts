...
export const CHAIN_ID = import.meta.env.DAPP_CHAIN_ID as ChainId
export const API_PREFIX_URL = API_PREFIX_URLS[CHAIN_ID] as string
export const EXPLORER_SCAN_URL = EXPLORER_SCAN_URLS[CHAIN_ID] as string
